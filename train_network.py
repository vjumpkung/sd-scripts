...
class NetworkTrainer:
    ...
    def train(self, args):
        ...
        if args.custom_timesteps:
            accelerator.print(f"run custom timesteps with std={args.timesteps_std} mean_t={args.timesteps_mean_t} left_sigma={args.timesteps_left_sigma} right_sigma={args.timesteps_right_sigma} low_boost_range={(args.timesteps_low_boost_range_start, args.timesteps_low_boost_range_end)} low_boost_factor={args.timesteps_low_boost_factor}")
